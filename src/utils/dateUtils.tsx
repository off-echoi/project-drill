...
// 함수의 인자로 넣는 날짜 형식
type DatePatternType = `${number}${number}${number}${number}-${number}${number}-${number}${number}` | Date
 ...
 * @returns 포멧팅 된 날짜 형식
 */
export const formattingDate = (fullDate: DatePatternType, format: DateFormatType): string => {
